...
prediction_dir = os.getcwd()+f'/data/working/prediction_{model_name}_{sampling_method}_{data_option}_bootstrap'
...
# now we randomly split the dataset
...
for counter in range(1000):
    ...
    train_index, test_index = train_test_split(index, test_size=0.2, train_size=0.8, random_state=counter)
