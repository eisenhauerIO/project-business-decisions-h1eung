...
#SBATCH --output=/home/hgz5390/npnetwork_RR/RR_simulation_node_level_split/quest_output/sample_job.%A_%a.out ## use the jobid (A) and the specific job index (a) to name your log file
...
IFS=$'\n' read -d '' -r -a input_arguments < input_arguments_coeff321_g15.txt
