...
#SBATCH --output=/home/hgz5390/npnetwork_RR/RR_simulation_null/quest_output/sample_job.%A_%a.out ## use the jobid (A) and the specific job index (a) to name your log file
...
python /home/hgz5390/npnetwork_RR/RR_simulation_null/simulation_test_null_WS_0.275.py --input-argument-1 ${input_args[0]} --input-argument-2 ${input_args[1]}
